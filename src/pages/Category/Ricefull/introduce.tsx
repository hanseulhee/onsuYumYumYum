    ...
    <main css={mainSizeWrapper}>
      ...
      {/* <div css={introSizeWrapper}>
        ...
        <div css={summaryWrapper}>
          ...
          <OneLineContent summary="성공회대학교 미가엘관 1층에 위치하며 영업시간은 오전 11시 30분부터 오후 13시까지입니다." />
          <OneLineContent
            summary="
        주메뉴는 백반으로 운영되고 있으며 금액은 5,500원이고, 카드/현금 결제 모두 가능합니다."
          />
          ...
          <div css={cardWrapper}>
            <div css={cardInWrapper}>
              <IntroduceCard
                img="mando.jpg"
                title="자율 배식"
                summary="자율 배식으로 이루어지고 있어요. 드실 만큼 담아주세요."
              />
              <IntroduceCard
                img="mando.jpg"
                title="음식"
